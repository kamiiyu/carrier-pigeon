...
set :application, "carrier-pigeon"
set :repo_url, "git@git.xogrp.com:GZ-Odyssey/carrier-pigeon.git"

# Default branch is :master
ask :branch, `git rev-parse --abbrev-ref HEAD`.chomp

# Default deploy_to directory is /var/www/my_app_name
set :deploy_to, "/home/siteroot/gzsdc-intranet/#{fetch(:application)}"
